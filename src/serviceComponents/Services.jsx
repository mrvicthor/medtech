            ...
            <ModalBody>
              <Text>
                ...
                <Stack spacing={4} justifyContent={"center"}  alignItems={"center"} m={"auto"}>
                  <Button _hover={{bgColor:"#009E60", color:"white"}} style={{ width: "60%", letterSpacing: 1.4 }} onClick={(e) => handleLocation("Olivia")}><FaMapMarkerAlt style={{ marginRight: '8px' }} />Olivia</Button>
                  <Button _hover={{bgColor:"#009E60", color:"white"}} style={{ width: "60%", letterSpacing: 1.4 }} onClick={(e) => handleLocation("Chloe")} > <FaMapMarkerAlt style={{ marginRight: '8px' }} />Chloe</Button>
                  <Button _hover={{bgColor:"#009E60", color:"white"}} style={{ width: "60%", letterSpacing: 1.4 }} onClick={(e) => handleLocation("Violet")} > <FaMapMarkerAlt style={{ marginRight: '8px' }} />Violet</Button>
                  <Button _hover={{bgColor:"#009E60", color:"white"}} style={{ width: "60%", letterSpacing: 1.4 }} onClick={(e) => handleLocation("Hazel")} > <FaMapMarkerAlt style={{ marginRight: '8px' }} />Hazel</Button>
                  <Button _hover={{bgColor:"#009E60", color:"white"}} style={{ width: "60%", letterSpacing: 1.4 }} onClick={(e) => handleLocation("Willow")} > <FaMapMarkerAlt style={{ marginRight: '8px' }} />Willow</Button>
                  <Button _hover={{bgColor:"#009E60", color:"white"}} style={{ width: "60%", letterSpacing: 1.4 }} onClick={(e) => handleLocation(e.target.textContent)}><FaMapMarkerAlt style={{ marginRight: '8px' }} />Lillian</Button>
                </Stack>
              </Text>
